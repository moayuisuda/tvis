...
describe("Demos", () => {
  ...
  it("should render Multi-series Line chart with title correctly", () => {
    expect(
      Chart({
  ...
  it("should render Interval chart with single-series color encode correctly", () => {
    expect(
      Chart({
        type: "interval",
        data: intervalData,
  ...
  it("should render DodgeX Interval chart with linear color correctly", () => {
    expect(
      Chart({
        type: "interval",
        data: dodgeData,
  ...
  it("should auto dodge Interval chart even if color equals x", () => {
    expect(
      Chart({
        type: "interval",
        data: dodgeData,
  ...
  it("should auto dodge Interval chart even if color equals x with custom colors", () => {
    expect(
      Chart({
        colors: ["#28a745", "#dc3545"],
        type: "interval",
